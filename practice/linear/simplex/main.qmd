...
[`\newpage`{=latex}]{.content-visible when-profile="practice"}
::::
:::::
...
::::::: {.content-hidden when-profile="student" when-profile="practice" unless-meta="alghoritm.select"}
...
::: {.content-hidden when-profile="practice"}
{{< include _alghoritm-problem.qmd >}}
:::

:::: {.content-visible when-profile="practice" layout-ncol="2"}

::: {#practice-linear-simplex-alghoritm-col1}

[`\vspace{0pt}`{=latex}]{.content-visible when-profile="practice"} <!-- грязный костыль-->

{{< include _alghoritm-problem.qmd >}}
:::

::: {#practice-linear-simplex-alghoritm-col2}
...
:::: {.content-hidden when-profile="student" when-profile="practice"}
::: {#sol-practice-2-simplex-alghoritm}
{{< lipsum 2 >}}
:::
::::
