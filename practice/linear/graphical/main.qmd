...
::: {#practice-2-graphical-solution-col1}
...
::: {#practice-2-graphical-solution-col2}
...
::: {.content-hidden unless-meta="special-case.type1.select" layout-ncol="2"}
{{< include _special-case-problem/no-fesiable-solution.qmd >}}

{{< include _special-case-problem/alternative.qmd >}}
:::

::: {.content-hidden unless-meta="special-case.type2.select" layout-ncol="2"}
